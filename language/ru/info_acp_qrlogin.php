...
$lang = array_merge(
	$lang, array(
		...
		'QRLOGIN_TIMEOUT'							=> 'Период опроса сервера, в сотнях милисекунд',
		'QRLOGIN_TIMEOUT_EXPLAIN'                   => 'С таким периодом будет проверятся нет ли посылки от телефона на вход. Значение задается в сотнях милисекунд, например 5 это два запроса в секунду, а 20 это один запрос в две секунды.',
		'QRLOGIN_POST_TIMEOUT'						=> 'Таймаут ожидания ответа программе в телефоне, секунд',
		'QRLOGIN_POST_TIMEOUT_EXPLAIN'              => 'Время ожидания ответа телефону. В секундах.',
		'QRLOGIN_LOGIN_TIMEOUT'						=> 'Таймаут ожидания входа, в минутах',
		'QRLOGIN_LOGIN_TIMEOUT_EXPLAIN'             => 'Время ожидания входа с телефона. Задается в минутах. Установите значение  в «0», что бы не останавливать ожидание.',
		...
		'QRLOGIN_YES_PROMPT'                        => 'Да(с приглашением)',
		...
		'QRLOGIN_HEADER_VIEW'                       => 'Показать в заголовке форума',
		'QRLOGIN_CENTER'                            => 'По центру',
		'QRLOGIN_RIGHT'                             => 'Справа',
		'QRLOGIN_HEADER_VIEW_EXPLAIN'               => 'Если выбрать эту опцию, код будет показан в заголовке форума, "по центру" - левее блока поиска, "справа" - в правом углу.',
